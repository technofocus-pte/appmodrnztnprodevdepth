...
> **Important:** Do not navigate away from the client secret page until
> after you have copied the secret value (not the ID) as you'll not have
> access to the secret value again.
>
> ![](./media/image11.png)
...
1.  In your browser, navigate
    to [https://make.powerapps.com](https://make.powerapps.com/) and
...
1.  Go to [https://github.com](https://github.com/) and click **Sign
...
4.  Delete the pre-created content, paste the content from
    the [export-and-branch-solution-with-spn-auth.yml](https://github.com/microsoft/powerplatform-actions-lab/blob/main/sample-workflows/export-and-branch-solution-with-spn-auth.yml) file.
...
>
> To get Environment URL, go to **Power Platform Admin center**. Select
> **Environments** from left navigation, click on **Dev One** and then
...
>
> Congratulations, you have just created your first GitHub workflow
