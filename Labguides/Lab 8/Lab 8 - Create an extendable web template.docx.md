# **Lab 8: Create an extendable web template**
...
4.  In the **Add a page** dialog, complete the following steps:
    ...
    1.  Select **Custom layouts** and then select **Directory Page
        Template**.
...
> the data. Using this command instead rebuilds the site cache.
>
